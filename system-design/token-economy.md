...
The QoS score is used to weight the online time of the node so that under the same online time, the node providing higher quality service gets more rewards.
