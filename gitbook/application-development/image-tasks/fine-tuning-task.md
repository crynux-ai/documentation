...
The fine tuning task aims to fine tune a lora model for a pretrained stable diffusion model.
...
The argument `name` defines the name of the dataset to train on. It can be Huggingface dataset ID, or a path pointing to a local copy of a dataset
in your filesystem.
