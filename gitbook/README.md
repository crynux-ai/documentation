...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <a href="https://drive.google.com/uc?id=1T2ogxVaQnldgV_bl7GWVAAxjsUtQxM52&export=download">crynux-node-helium-v2.0.6-windows-x64.zip</a>
            </td>
        </tr>
        <tr>
            <td>Mac</td>
            ...
            <td>
                <a href="https://github.com/crynux-ai/crynux-node/releases/download/v2.0.6/crynux-node-helium-v2.0.6-mac-arm64-signed.dmg">crynux-node-helium-v2.0.6-mac-arm64-signed.dmg</a>
            </td>
        </tr>
        <tr>
            <td>Linux</td>
            <td>Nvidia GPU with 8GB VRAM</td>
            <td>
                <a href="https://drive.google.com/uc?id=1fywy7_LwDRprm_Amfpd2moftf_s9h8Iu&export=download">crynux-node-helium-v2.0.6-linux-bin-x64.tar.gz</a>
            </td>
        </tr>
        <tr>
            <td>Docker</td>
